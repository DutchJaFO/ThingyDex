...
namespace ThingyDexer.Model.Table
{
    public class CultnameTableSet
    {
        ...
        public CultnameTableSet(Random randomizer,string[] nameTable, string[] prefixTable, string[] somethingTable)
        {
            PrefixNameTable = new TextTable(randomizer, "Prefix", prefixTable);
            NameTable = new TextTable(randomizer, "Name", nameTable);
            PrefixTable = new TextTable(randomizer, "Prefix", prefixTable);
